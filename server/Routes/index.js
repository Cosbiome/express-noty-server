...
router.put('/pedidoCosbiome', async(req, res) => {
    let numPedidos = await PedidosCosbiome.findByIdAndUpdate('5f4d29056dc30b6349a68fb4', {
...
router.put('/soalRutas', async(req, res) => {
    let conteosSoal = await ConteosSoal.findByIdAndUpdate('5f4e5c26d9d3ec54c254f431', {
